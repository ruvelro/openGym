...
| You have | Goes to |
| --- | --- |
| A question, or self-hosting that won't behave | [Discussions → Q&A](https://github.com/ruvelro/openGym/discussions/categories/q-a) |
| An idea you're not sure about yet | [Discussions → Ideas](https://github.com/ruvelro/openGym/discussions/categories/ideas) |
| A reproducible bug | [Issues](https://github.com/ruvelro/openGym/issues) |
